...
'''
    ...
    def _create_pyoxidizer_config(self, target_platform):
        """Genera pyoxidizer.bzl usando la plantilla final sin f-strings."""
    ...
    '''
        with open(self.project_dir / "pyoxidizer.bzl", "w") as f:
            f.write(config)
        print("[PyOxidizer] Archivo de configuración pyoxidizer.bzl generado con plantilla final (sin f-strings).")
