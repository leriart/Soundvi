...
class AboutDialog(QDialog):
    ...
    def _construir_ui(self):
        ...
        lbl_version = QLabel("v4.8 — Edición 'It compiles, ship it' ➡")
    ...
    def _crear_tab_zoundvi(self) -> QWidget:
        ...
        desc.setText(
            ...
            "▶ Editando video con tijeras (herramientas digitales? para qué?)<br>"
            "• Esperando renders con cara de 'me quiero morir' (relatable)<br>"
            "★ Celebrando exports como si hubiera ganado el mundial<br>"
            "☠ Aterrándose con BSoDs y crashes épicos<br>"
            "☕ Tomando café (o lo que sea que tomen los zombies)<br>"
            "• Filosofando en el trono (porque hasta los zombies necesitan su tiempo)<br><br>"
