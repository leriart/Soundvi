...
_SETTINGS_FILE = os.path.join(_RAIZ, "soundvi_settings.json")
...
class SettingsDialog(QDialog):
    ...
    def _crear_tab_general(self) -> QWidget:
        ...
        self._combo_tema.addItems(["Oscuro", "Claro"])
    ...
    def _guardar_settings(self):
        ...
        try:
            ...
            log.info("Configuracion guardada en %s", _SETTINGS_FILE)
        except Exception as e:
            log.error("Error guardando configuracion: %s", e)

    def _cargar_settings(self):
        """Carga la configuracion desde disco."""
        ...
        try:
            ...
            log.info("Configuracion cargada desde %s", _SETTINGS_FILE)
        except Exception as e:
            log.warning("Error cargando configuracion: %s", e)
