...
class PanelPrimerosPasos(QFrame):
    ...
    def __init__(self, parent: Optional[QWidget] = None):
        ...
        # Pasos como botones
        pasos = [
            ("1.", "Importar medios", "Agrega tus archivos de video y audio", "import_media"),
            ("2.", "Agregar al timeline", "Arrastra clips al timeline para organizarlos", "add_to_timeline"),
            ("3.", "Aplicar un efecto", "Haz doble clic en un módulo para aplicarlo", "open_modules"),
            ("4.", "Exportar video", "Genera tu video final listo para compartir", "export_video"),
        ]
