...
class MiEfectoModule(Module):
    ...
    def get_config_widgets(self, parent: QWidget, app) -> QWidget:
        ...
        header = QLabel("Configuración de Mi Efecto:")
        header.setStyleSheet("font-weight: bold; font-size: 9pt;")
        ...
        row_layout.addWidget(QLabel("Radio:"))
        
        val_label = QLabel(str(self._config["parametro_ejemplo"]))
        
        slider = QSlider(Qt.Orientation.Horizontal)
        slider.setRange(10, 200)
        slider.setValue(self._config["parametro_ejemplo"])
        ...
        slider.valueChanged.connect(update_param)
